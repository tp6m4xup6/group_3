...
public class DBconnect {
	...
	/*
	 * upload hiv.csv to database path: the site of hiv.csv
	 */
	...
	/*
	 * upload born.csv to database path: the site of hiv.csv
	 */
	...
	public static boolean Born_upload(String path) {
		...
		for (int i = 3; i < csv.data.size(); i++) {
			...
			try {
				...
				year_2013 = "_";
				/*
				 * year_2012 = csv.data.get(i).get(57).toString(); year_2012 =
				 * year_2012.substring(1,year_2012.length()-1); year_2013 =
				 * csv.data.get(i).get(58).toString(); year_2013 =
				 * year_2013.substring(1,year_2013.length()-1);
				 */
