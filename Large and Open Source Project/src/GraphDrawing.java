...
public class GraphDrawing {
	...
	public static void drawImage() throws IOException{
		...
		/*for(int i=0;i<StringBorn.size();i++){
			for(int j=0;j<StringBorn.get(0).size();j++){
        ...
        JFreeChart chart = ChartFactory.createBarChart3D( 
                            "Title", // ¹ÏªºŒÐÃD 
                            "Developed Country",  // x ®yŒÐŒÐÃD 
                            "%", // y ®yŒÐŒÐÃD 
                            dataset, // §A©ñŒÆŸÚªºŠa€è 
                            PlotOrientation.VERTICAL, // ¹Ïªí€èŠV¡G€ô¥­¡B««ªœ 
                            true,     // ¬O§_Åã¥Ü¹ÏšÒ 
                            false,     // ¬O§_ tooltips €ušã  
                            false     // ¬O§_¥ÍŠšURL 
                            ); 
